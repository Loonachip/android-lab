package com.example.loonachip.android_lab;
...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public void dodaj(Animal zwierz){
        ...
        v.put("gatunek", zwierz.getGatunek());
        v.put("kolor", zwierz.getKolor());
        v.put("wielkosc", zwierz.getWielkosc());
        v.put("opis", zwierz.getOpis());

        db.insert("animals", null, v);
    ...
    public int aktualizuj(Animal zwierz){
        ...
        int i = db.update("animals", v, "_id = ?", new String[] { String.valueOf(zwierz.get_id()) } );
    ...
    public Animal pobierz(int id) {
        ...
        Cursor cursor =
                db.query("animals", // table name
                        new String[]{"_id", "gatunek", "kolor", "wielkosc", "opis"}, // column names
                        "_id = ?", // selections
                        new String[]{
